class GitController{
    ...
    renderiza(){            
        this.inputSearch.oninput= () =>{
            ...
            //Efeito deslizante da barra laranja
            document.querySelector(".barra")
                .classList.add("barra2");
            document.querySelector(".div-tabela-repositorios")
                .classList.add("div-tabela-repositorios-change");
        };
    ...
    //Filtra as estrelas de cada repositório
